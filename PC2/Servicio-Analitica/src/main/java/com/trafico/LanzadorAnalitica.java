...
import com.trafico.servicios.GestorBaseDato;
...
public class LanzadorAnalitica {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("  - Puerto REQ/REP (Analítica↔Semáforo): " + config.getServicios().getAnalitica().getPuerto_push_semaforoctl());
            ...
            GestorBaseDato gestorBaseDatos = new GestorBaseDato();
